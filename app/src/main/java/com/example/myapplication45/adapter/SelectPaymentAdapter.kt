...
import com.example.myapplication45.model.PaymentMethod

class SelectPaymentAdapter(context: Context, @LayoutRes resource: Int,
                           list: List<PaymentMethod>) : ArrayAdapter<PaymentMethod?>(context, resource, list) {
